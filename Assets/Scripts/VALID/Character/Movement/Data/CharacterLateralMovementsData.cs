...
namespace BlownAway.Character.Movements.Data
{
    ...
    public class CharacterLateralMovementsData : ScriptableObject
    {
        ...
        [field: Header("Derive")]
        [field: SerializeField, Tooltip("The maximum deplacement speed the character aims to moves at while deriving")] public float BaseDeriveLateralSpeed { get; private set; }
        [field: SerializeField, Tooltip("The time it takes to the character to reach the maximum speed (BaseDeriveLateralSpeed) after pressing the inputs")] public float BaseDeriveTime { get; private set; }
        [field: SerializeField, Tooltip("The lerp used by character to reach the maximum speed (BaseDeriveLateralSpeed) after pressing the inputs")] public AnimationCurve BaseDeriveCurve { get; private set; }
        [field: SerializeField, Range(0, 1), Tooltip("The time it takes to the character to transition from its current direction to the target direction while deriving")] public float DeriveDirectionTurnSpeed { get; private set; }
