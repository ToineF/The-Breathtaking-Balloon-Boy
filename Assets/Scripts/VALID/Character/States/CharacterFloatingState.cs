...
namespace BlownAway.Character.States
{
    public class CharacterFloatingState : CharacterBaseState
    {
        ...
        {
            Debug.Log("FLOATING");
            manager.MovementManager.LerpGravityTo(manager, manager.MovementManager.FallData.FloatingGravity, manager.MovementManager.FallData.FloatingMinGravity, manager.MovementManager.FallData.FloatingMaxGravity, manager.MovementManager.FallData.FloatingGravityTime, manager.MovementManager.FallData.FloatingGravityAccel);
